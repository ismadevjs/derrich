...
<form action="{{ route('notifications.store') }}" method="POST">
    ...
    <div class="form-group mb-3">
        ...
        <input type="number" class="form-control @error('user_id') is-invalid @enderror" id="user_id" name="user_id" value="{{ old('user_id') }}">
        @error('user_id')
    ...
    <div class="form-group mb-3">
        ...
        <input type="datetime-local" class="form-control @error('date_envoi') is-invalid @enderror" id="date_envoi" name="date_envoi" value="{{ old('date_envoi') }}">
        @error('date_envoi')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
